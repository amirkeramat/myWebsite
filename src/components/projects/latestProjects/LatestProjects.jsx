import { StarOutlined,GithubFilled } from "@ant-design/icons";
  ...
  return (
    <div className='relative grid grid-cols-1 md:grid-cols-2 duration-500 justify-center bg-zinc-800 items-center p-4 hover:drop-shadow-2xl hover:shadow-lime-600'>
      {live ? (
        <a
          href={link}
          className='absolute top-0 right-2 text-yellow-400 text-2xl flex flex-col animate-pulse'>
      ...
      <a
        href={github}
        className='absolute top-0 left-1 text-yellow-400 text-2xl'>
        <GithubFilled />
      </a>
